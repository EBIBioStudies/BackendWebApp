...
//  process(act, params, request, response, resp);
 ...
 private void deleteClassifier(ParameterPool params, HttpServletRequest request, Response resp, Session sess) throws IOException
 {
  String classifierName= params.getParameter(ClassifierParameter);
 ...
 private void deleteTag(ParameterPool params, HttpServletRequest request, Response resp, Session sess) throws IOException
 {
  deleteTag(params, request, resp, sess, false);
 }
 
 private void deleteTagTree(ParameterPool params, HttpServletRequest request, Response resp, Session sess) throws IOException
 {
  deleteTag(params, request, resp, sess, true);
 }

 private void deleteTag(ParameterPool params, HttpServletRequest request, Response resp, Session sess, boolean cascade) throws IOException
 {
  String classifierName = null;
  String tagName = null;
  String tag = params.getParameter(TagParameter);
  ...
  try
  {
   BackendConfig.getServiceManager().getTagManager().deleteTag(tagName, classifierName, cascade, sess.getUser());
 ...
 private void createClassifier(ParameterPool params, HttpServletRequest request, Response resp, Session sess) throws IOException
 {
  String classifierName= params.getParameter(ClassifierParameter);
  String description=params.getParameter(DescParameter);
  ...
  try
  {
   BackendConfig.getServiceManager().getTagManager().createClassifier(classifierName, description, sess.getUser());
 ...
 private void createTag(ParameterPool params, HttpServletRequest request, Response resp, Session sess) throws IOException
 {
  String tagName=null;
  String classifierName=null;
  ...
  try
  {
   BackendConfig.getServiceManager().getTagManager().createTag(tagName, description, classifierName, parentTag, sess.getUser());
