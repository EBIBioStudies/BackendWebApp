...
public class JPAAccessionManager implements AccessionManager
{
 ...
 @Override
 public synchronized String getNextAccNo( String prefix, String suffix, User usr ) throws SecurityException, ServiceException
 {
 ...
 @Override
 public synchronized long incrementIdGen( String prefix, String suffix, int num, User usr ) throws SecurityException, ServiceException
 {
...
//   IdGen gen = cache.get( cacheKey );
   ...
   if( gen == null )
   {
    if( checkPermissions && ! BackendConfig.getServiceManager().getSecurityManager().mayUserCreateIdGenerator(usr) )
